% Autumn Routt
% 8/27/2025
% Calculates angle, angular velocity, and angular acceleration
% for inverted pendulum on a cart with SRM-style controller

function dX = dPendulumStates(t, X, ang_acc, cart_acc_spline, M, m, l_lumped, theta_a, I_lumped, kp, kv, ka, iter, delay)
