...
% cart_acc_spline = spline(temp_t,temp_acc*(pertMag/2));
...
peakTrqs = zeros(length(kp_array),length(kv_array));
peakCOMangDisp = zeros(length(kp_array),length(kv_array));
...
for i = 1:length(m_array)
    ...
    for kp = kp_array
        ...
        for kv = kv_array
            ...
            %     [dX,cart_trq,gravity_trq,musc_trq,cart_acc,cart_vel,cart_pos] = dPendulumStatesAndTrqs(t_sim, x_sim, ang_acc, cart_acc_spline, M, m, l_lumped, theta_a, I_lumped, kp, kv, ka, iter, delay);
            ...
            thetaSumSqrd(kp_iter,kv_iter) = sum(adjustedTheta.^2);
...
ylabel('kv')
zlabel(CFstr)
figName = ['Output/SurfWeightedCF_C1',num2str(C1),'_C2',num2str(C2),'_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/SurfWeightedCF_C1',num2str(C1),'_C2',num2str(C2),'_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
title(CFstr)
colorbar;
figName = ['Output/ContourWeightedCF_C1',num2str(C1),'_C2',num2str(C2),'_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/ContourWeightedCF_C1',num2str(C1),'_C2',num2str(C2),'_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
ylabel('kv')
zlabel(OV1str)
figName = ['Output/Surf_C1',num2str(C1),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/Surf_C1',num2str(C1),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
title(OV1str)
colorbar;
figName = ['Output/Contour_C1',num2str(C1),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/Contour_C1',num2str(C1),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
ylabel('kv')
zlabel(OV2str)
figName = ['Output/Surf_C2',num2str(C2),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/Surf_C2',num2str(C2),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
title(OV2str)
colorbar;
figName = ['Output/Contour_C2',num2str(C2),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/Contour_C2',num2str(C2),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
ylabel('kv')
zlabel(OV3str)
figName = ['Output/Surf_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/Surf_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
...
title(OV3str)
colorbar;
figName = ['Output/Contour_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.fig'];
savefig(figName)
pngName = ['Output/Contour_C3',num2str(C3),'_kp',int2str(kp_array(1,1)),'to',int2str(kp_array(1,end)),'_kv',int2str(kv_array(1,1)),'to',int2str(kv_array(1,end)),'_m',int2str(m),str,'.png'];
saveas(fig,pngName)
